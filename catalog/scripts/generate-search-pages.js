...
/**
 * Generates individual HTML pages for each repository to enable Pagefind indexing.
 * Each page includes all searchable content and redirects to the main page.
 */
...
<head>
  ...
  <title>${repo.name} - CAISI Research Catalog</title>
  ...
  <style>
    ...
    .type-badge { background: #ede9fe; color: #4800ac; }
    .year-badge { background: #f0fdf4; color: #15803d; }
    h1 { color: #4800ac; margin-bottom: 10px; }
    ...
    .link { color: #4800ac; text-decoration: none; }
    .redirect-notice {
      background: #ede9fe;
...
<body data-pagefind-body>
  <div class="redirect-notice">
    <strong>Redirecting...</strong> If you are not redirected, <a href="${basePath}/#${repoSlug}" class="link">click here</a>.
  </div>
